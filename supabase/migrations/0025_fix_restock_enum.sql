-- Migration: 0025_fix_restock_enum.sql
...
BEGIN
    ...
    LOOP
        ...
        -- FIXED: Used 'ARRIVAL' instead of 'RESTOCK' to match the ENUM definition
        INSERT INTO stock_movements (variant_id, type, quantity_change, notes)
        VALUES (v_movement.variant_id, 'ARRIVAL'::stock_movement_type, v_total_added, COALESCE(NULLIF(trim(v_movement.notes), ''), 'Stock Arrival'));
