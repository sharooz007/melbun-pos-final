-- Migration: 0082_fix_returns_metrics.sql
-- Safely deducts returned COGS, Profit, and Sales from all reporting endpoints with strict subquery limits and drop guards.
