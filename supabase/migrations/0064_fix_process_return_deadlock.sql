-- Migration: 0064_fix_process_return_deadlock.sql
-- Fixes concurrency lock inversion deadlock in process_return by standardizing lock order:
-- Invoices is locked FIRST, followed by invoice_items, variants, and customers.
