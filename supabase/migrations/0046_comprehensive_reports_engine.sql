-- Migration: 0046_comprehensive_reports_engine.sql
-- Comprehensive reporting RPC with 8 KPIs, Cash/UPI breakdown, trend series, and all 12 drilldown tabs
...
BEGIN
    ...
    INTO v_total_collected, v_cash_collected, v_upi_collected
    FROM payments p
    ...
    FROM (
        WITH invoice_months AS (
            SELECT 
                ...
                COALESCE(SUM(i.discount_amount), 0) AS discount,
                COALESCE(SUM(ii_summary.cost_sum), 0) AS cogs,
